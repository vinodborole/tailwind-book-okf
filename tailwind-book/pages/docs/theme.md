...
`@import "tailwindcss";@theme {  --font-poppins: Poppins, sans-serif;}``<h1 class="font-poppins">This headline will use Poppins.</h1>`
...
1. Source page: https://tailwindcss.com/docs/theme
