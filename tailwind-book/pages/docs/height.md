...
For CSS variables, you can also use the `h-(` syntax:`<custom-property>`)

`<div class="h-(--my-height) ...">  <!-- ... --></div>`
This is just a shorthand for `h-[var(` that adds the `<custom-property>`)]`var()` function for you automatically.
