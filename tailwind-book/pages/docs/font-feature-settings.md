...
| `font-features-(` | `font-feature-settings: var(` | 
...
`<p class="font-features-['smcp','onum'] ...">This text uses small caps and oldstyle numbers.</p>`Use the `font-features-(` syntax to apply font feature settings from a CSS variable:`<custom-property>`)
...
`<p class="font-features-['tnum'] md:font-features-['smcp'] ...">  Lorem ipsum dolor sit amet...</p>`Learn more about using variants in the [variants documentation](/docs/hover-focus-and-other-states).
