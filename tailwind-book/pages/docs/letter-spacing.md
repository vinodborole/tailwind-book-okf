...
Use the `tracking-[` syntax to set the letter spacing based on a completely custom value:`<value>`]

`<p class="tracking-[.25em] ...">  Lorem ipsum dolor sit amet...</p>`
For CSS variables, you can also use the `tracking-(` syntax:`<custom-property>`)

`<p class="tracking-(--my-tracking) ...">  Lorem ipsum dolor sit amet...</p>`
This is just a shorthand for `tracking-[var(` that adds the `<custom-property>`)]`var()` function for you automatically.
