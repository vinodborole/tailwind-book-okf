...
Use the `auto-rows-[` syntax to set the size of implicitly-created grid rows based on a completely custom value:`<value>`]

`<div class="auto-rows-[minmax(0,2fr)] ...">  <!-- ... --></div>`
For CSS variables, you can also use the `auto-rows-(` syntax:`<custom-property>`)

`<div class="auto-rows-(--my-auto-rows) ...">  <!-- ... --></div>`
This is just a shorthand for `auto-rows-[var(` that adds the `<custom-property>`)]`var()` function for you automatically.
