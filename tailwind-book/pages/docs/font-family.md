...
| `font-(family-name:` | `font-family: var(` | 
| `font-[` | `font-family: ` | 
...
`<p class="font-[Open_Sans] ...">  Lorem ipsum dolor sit amet...</p>`For CSS variables, you can also use the `font-(family-name:` syntax:`<custom-property>`)

`<p class="font-(family-name:--my-font) ...">  Lorem ipsum dolor sit amet...</p>`This is just a shorthand for `font-[family-name:var(` that adds the `<custom-property>`)]`var()` function for you automatically.
