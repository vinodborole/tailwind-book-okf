...
`@import "tailwindcss";@layer components {  .DocSearch-Hit--Result {    background-color: --alpha(var(--color-gray-950) / 10%);  }}`Use `@theme` to add custom colors to your project under the `--color-*` theme namespace:
...
1. Source page: https://tailwindcss.com/docs/colors
