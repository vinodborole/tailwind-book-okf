...
For CSS variables, you can also use the `list-(` syntax:`<custom-property>`)

`<ol class="list-(--my-marker) ...">  <!-- ... --></ol>`
This is just a shorthand for `list-[var(` that adds the `<custom-property>`)]`var()` function for you automatically.
