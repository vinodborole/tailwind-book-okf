...
`<p class="leading-[1.5] ...">  Lorem ipsum dolor sit amet...</p>`For CSS variables, you can also use the `leading-(` syntax:`<custom-property>`)

`<p class="leading-(--my-line-height) ...">  Lorem ipsum dolor sit amet...</p>`This is just a shorthand for `leading-[var(` that adds the `<custom-property>`)]`var()` function for you automatically.
