...
`<img class="object-[25%_75%] ..." src="/img/mountains.jpg" />`For CSS variables, you can also use the `object-(` syntax:`<custom-property>`)

`<img class="object-(--my-object) ..." src="/img/mountains.jpg" />`This is just a shorthand for `object-[var(` that adds the `<custom-property>`)]`var()` function for you automatically.
