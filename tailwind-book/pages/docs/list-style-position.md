...
resource: https://tailwindcss.com/docs/list-style-position
...
`<ul class="list-outside md:list-inside ...">  <!-- ... --></ul>`Learn more about using variants in the [variants documentation](/docs/hover-focus-and-other-states).

# Citations

1. Source page: https://tailwindcss.com/docs/list-style-position
