...
For CSS variables, you can also use the `shrink-(` syntax:`<custom-property>`)

`<div class="shrink-(--my-shrink) ...">  <!-- ... --></div>`
This is just a shorthand for `shrink-[var(` that adds the `<custom-property>`)]`var()` function for you automatically.
